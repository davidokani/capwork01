...
const Signinform = () => {
    return (
        <div className="signinform">
            ...
            <div className="reg"><Link to="/register" className="rego">Don't have an account? Register</Link>
            </div>
            <div className="reg"><Link to="/recover" className="rego">Forgot Password?</Link>
            </div>
        </div>
    )
};
